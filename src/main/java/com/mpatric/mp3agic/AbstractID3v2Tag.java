...
public abstract class AbstractID3v2Tag implements ID3v2 {
  ...
  private int unpackFooter(byte[] bytes, int offset) throws InvalidDataException {
    if (!FOOTER_TAG.equals(
        BufferTools.byteBufferToStringIgnoringEncodingIssues(bytes, offset, FOOTER_TAG.length()))) {
  ...
  public void setAlbumArtist(String albumArtist) {
    if (albumArtist != null && albumArtist.length() > 0) {
      invalidateDataLength();
      ID3v2TextFrameData frameData =
          new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(albumArtist));
  ...
  public void setGenre(int genre) {
    if (genre >= 0) {
      ...
      String combinedGenre = /*"(" + genre + ")" +*/
          genreDescription; // Removed genre because I am only setting with description.
      ID3v2TextFrameData frameData =
          new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(combinedGenre));
  ...
  public String getOriginalArtist() {
    ID3v2TextFrameData frameData =
        extractTextFrameData(obseleteFormat ? ID_ORIGINAL_ARTIST_OBSELETE : ID_ORIGINAL_ARTIST);
    if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
    return null;
  }
  ...
  public void setOriginalArtist(String originalArtist) {
    if (originalArtist != null && originalArtist.length() > 0) {
      invalidateDataLength();
      ID3v2TextFrameData frameData =
          new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(originalArtist));
  ...
  private ID3v2PictureFrameData createPictureFrameData(String id) {
    ...
    if (frameSet != null) {
      ...
      try {
        if (obseleteFormat)
          frameData =
              new ID3v2ObseletePictureFrameData(useFrameUnsynchronisation(), frame.getData());
